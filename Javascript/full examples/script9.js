...
function replaceSecondItem(item) {
    ...
    secondItem.outerHTML = "<li>replace demo 2</li>"

}
replaceSecondItem(2);

// replace ALL items excepted second item
...
// case 1
        ...
        // }
// case 2
        item.outerHTML = "<li>Replace demo 3</li>"
    });
}
replaceAllItems();
...
// case 2
        // item.outerHTML = "<li>Replace demo 3</li>"
// case 3
        item.outerHTML = index === 1 ? "<li>second item 2</li>" : "<li>Replace demo 4</li>"
    });
}
replaceAllItems();
